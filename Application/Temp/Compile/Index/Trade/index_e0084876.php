...
<html>
	...
	<body>
		...
		<div class="cart_box">
			<div class="cart1">
				<a href="<?php echo U('Index/index');?>">首页</a>&nbsp<i>/</i>&nbsp<span>购物车结算</span>&nbsp<i>/</i>&nbsp<span>填写订单</span>
			</div>
			<ul class="cart1_ul">
			...
			<div class="trade2_box">
				<div class="trade2_con">
					...
					<form  action="<?php echo U('Trade/sub');?>" method="post">
					<?php foreach ($addata as $k=>$v){?>
					<div class="adress">
						<input type="radio" name="id" checked="checked" id="" value="<?php echo $v['id'];?>" />
						<div class="adress_con">
							<h4><?php echo $v['names'];?></h4>
							<span><?php echo $v['phone'];?></span><br />
							<span><?php echo $v['adress'];?></span>
						</div>
						<a class="del" href="<?php echo U('Trade/del',array('id'=>$v['id']));?>">X</a>
					</div>	
					<?php }?>
					<?php foreach ($catedata['goods'] as $k=>$v){?>
					<input type="hidden" name="sid[]" id="sid" value="<?php echo $k;?>" />
					<?php }?>
					...
					<div class="dizhi">
						<form id="add" action="<?php echo U('add');?>" method="post">
							<span>*收货人姓名</span><br />
			...
			<div class="trade_right">
				<ul>
					<li>商品数量:<span><?php echo $catedata['total_rows'];?></span></li>
					<li>总价:<span>￥<?php echo $catedata['total'];?>.00</span></li>
				</ul>
				...
				<div class="zongji">
					...
					<h4 class="xiaojir"> ￥<?php echo $catedata['total'];?>.00</h4>
