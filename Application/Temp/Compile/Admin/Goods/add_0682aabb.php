...
<body>
	...
	<form action="" method='post'>
			...
			<table class='hd-table hd-table-form'>
				...
				<tbody>
					...
					<!--<tr class="info">
						<td>单位</td>
						<td>
							<input type="text" name='gnumber' value=''/>
						</td>
					</tr>-->
					<tr class="info">
						<td>商品价格</td>
					...
					<tr class="info">
						<td>附加价格</td>
						<td>
							<input type="text" name='attr_price'/>
						</td>
					</tr>
					<!--<tr class="info">
						<td>点击次数</td>
						<td>
							<input type="text" name='gclick'/>
						</td>
					</tr>-->
				</tbody>
			</table>
			...
			<table class='hd-table hd-table-form'>
				<tr class="hide info">
					<td>
						<script id="editor" type="text/plain" style="width:600px;height:200px;" name="servace"></script>
                     <script>
			...
			<table class='table'>
				<tr class="hide info">
					<td>
						<script id="editor1" type="text/plain" style="width:600px;height:200px;" name="good_detail"></script>
	                     <script>
